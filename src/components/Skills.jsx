...
const frontEndTechs = [
    ...
    },
    {
        ...
        iconSvgPathD : "M12 6.036c-2.667 0-4.333 1.325-5 3.976 1-1.325 2.167-1.822 3.5-1.491.761.189 1.305.738 1.906 1.345C13.387 10.855 14.522 12 17 12c2.667 0 4.333-1.325 5-3.976-1 1.325-2.166 1.822-3.5 1.491-.761-.189-1.305-.738-1.907-1.345-.98-.99-2.114-2.134-4.593-2.134zM7 12c-2.667 0-4.333 1.325-5 3.976 1-1.326 2.167-1.822 3.5-1.491.761.189 1.305.738 1.907 1.345.98.989 2.115 2.134 4.594 2.134 2.667 0 4.333-1.325 5-3.976-1 1.325-2.167 1.822-3.5 1.491-.761-.189-1.305-.738-1.906-1.345C10.613 13.145 9.478 12 7 12z",
    },
    {
        id : 4,
        techName : "HTML5",
...
const othersTechs = [
    ...
    },
    {
        id : 2,
        techName : "Laravel",
        iconClassName : "fa-brands fa-laravel",
        isIcon : true,
        isSVG : false,
        iconSvgViewBox : "",
        iconSvgPathD : "",
    },
    {
        id : 3,
        techName : "Docker",
        iconClassName : "fa-brands fa-docker",
        isIcon : true,
        isSVG : false,
        iconSvgViewBox : "",
        iconSvgPathD : "",
        ...
        <>
            <div className="bg-white py-8 sm:py-8">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">            
                    ...
                    <div className="mx-auto mt-6 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-6 border-t text-black border-b border-gray-200 pt-6 sm:mt-10 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                        {techNameToVar.map((tech) => (
                            <div className="flex-1 border border-black rounded-3xl">
                                <div className="text-2xl font-mono">
                                    {tech.name}
                                </div>
                                <ul className="hover:text-sky-500">
                                    {tech.var.map((frontEndTech) => (
                                        <li>
                                            {frontEndTech.isIcon && (
                                                <i className={frontEndTech.iconClassName}></i>
                                            )}
                                            {frontEndTech.isSVG && (
                                                <svg width={24} height={24} className="fill-current inline" viewBox={frontEndTech.iconSvgViewBox}>
                                                    <path d={frontEndTech.iconSvgPathD}></path>
                                                </svg>
                                            )}
                                            {frontEndTech.techName}
                                        </li>
                                    ))} 
                                </ul>
                            </div>                                                       
