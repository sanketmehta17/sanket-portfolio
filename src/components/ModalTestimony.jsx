...
export default function ModalTestimony(){
    ...
    const handleClick = async e => {
        ...
        e.preventDefault();
        try{
            await axios.post("http://localhost:3001/createTestimonial", testimony)
            setSubmitted(true);
            setInterval(() => {
    ...
    return(
        <> 
        {/* <!-- Main modal --> */}
        <div id="testimony-modal" tabindex="-1" aria-hidden="true" className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative p-6 w-full max-w-md max-h-full">                
                ...
                <div className="relative bg-white rounded-lg shadow">
                    ...
                    {submitted != null && !submitted && 
                    <>
                        <div id="toast-danger" class="fixed flex items-center w-full max-w-fit p-4 mb-4 text-gray-500 bg-white rounded-lg shadow top-[5rem] right-4 sm:right-5" role="alert">
