const jobs = [
    {
        ...
        Description: [
            ...
            'Spearheaded the development of a web API for single sign-on authentication, resulting in a 30% reduction in login-related issues and improved overall user experience.',
            'Implemented scheduled tasks for business process automation, optimizing application data storage, and achieving a 15% time-saving in executive-level email handling.',
            'Established a SKU image repository, streamlining image management and ensuring a 25% reduction in image-related errors.',
