...
const jobs = [
    {
        ...
        Description: [
            ...
            'Automated monthly process of downloading data from the Stripe dashboard, aiding in financial analysis, with the help of Stripe API, achieving significant time savings.',
            ...
            'Implemented scheduled tasks for business process automation, optimizing application data storage, and automated email handling achieving in 100% time-saving.',
